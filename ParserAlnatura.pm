...
#
# Alnatura Parser. For educational purpose only.
#
...
sub conv_fields_to_shopify($$$$$$$)
{
    ...
    my $handle = Helpers::convert_title_to_handle( $fields[5] );
    ...
    my $title  = Helpers::sanitize_title( $fields[5] );
    ...
    my $cost_per_item  = Helpers::parse_price( $fields[7] );
